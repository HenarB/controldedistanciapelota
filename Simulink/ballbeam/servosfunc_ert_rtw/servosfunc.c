...
void servosfunc_step(void)
{
  ...
  /* S-Function (bloque1): '<S3>/S-Function Builder' */
  ...
  /* Update for S-Function (bloque1): '<S3>/S-Function Builder' */

  /* S-Function "bloque1_wrapper" Block: <S3>/S-Function Builder */
...
void servosfunc_initialize(void)
{
  ...
  /* External mode info */
  servosfunc_M->Sizes.checksums[0] = (1210060882U);
  servosfunc_M->Sizes.checksums[1] = (1157268206U);
  servosfunc_M->Sizes.checksums[2] = (2189295392U);
  servosfunc_M->Sizes.checksums[3] = (1396036458U);
  ...
  /* InitializeConditions for S-Function (bloque1): '<S3>/S-Function Builder' */
