 ...
 * C/C++ source code generated on : Fri Jul 19 14:14:51 2019
 *
...
void servosfunc_step(void)
{
   ...
   *  Operator: reciprocal
   */
  servosfunc_B.ManualSwitch = 1.0 / (servosfunc_P.Constant_Value_p +
    rtb_IntegralGain);
  ...
  TmpSignalConversionAtFilterDiff = (rtb_IntegralGain -
    servosfunc_P.Constant_Value_p) * servosfunc_B.ManualSwitch;
  ...
  rtb_FilterCoefficient = (servosfunc_P.FilterDifferentiatorTF_NumCoef[0] *
    ...
    servosfunc_DW.FilterDifferentiatorTF_states) * servosfunc_B.ManualSwitch *
    servosfunc_P.DiscretePIDController_N;

  /* Gain: '<S1>/Proportional Gain' */
  servosfunc_B.ManualSwitch = servosfunc_P.DiscretePIDController_P *
    rtb_IntegralGain;
  ...
  /* Sum: '<S1>/Sum Fdbk' */
  rtb_SignPreIntegrator = (servosfunc_B.ManualSwitch +
  ...
  /* Sum: '<S1>/Sum' */
  servosfunc_B.ManualSwitch = (servosfunc_B.ManualSwitch + rtb_SignPreIntegrator)
    + rtb_FilterCoefficient;

  /* Saturate: '<S1>/Saturate' */
  if (servosfunc_B.ManualSwitch > servosfunc_P.DiscretePIDController_UpperSatu)
  {
    servosfunc_B.ManualSwitch = servosfunc_P.DiscretePIDController_UpperSatu;
  } else {
    if (servosfunc_B.ManualSwitch < servosfunc_P.DiscretePIDController_LowerSatu)
    {
      servosfunc_B.ManualSwitch = servosfunc_P.DiscretePIDController_LowerSatu;
    }
  }
  ...
  if (servosfunc_P.ManualSwitch_CurrentSetting != 1) {
    servosfunc_B.ManualSwitch = servosfunc_P.ngulodeseado_Gain *
  ...
  if (servosfunc_B.ManualSwitch < 256.0) {
    if (servosfunc_B.ManualSwitch >= 0.0) {
      tmp = (uint8_T)servosfunc_B.ManualSwitch;
    } else {
      tmp = 0U;
    }
  } else {
  ...
  /* S-Function "bloque1_wrapper" Block: <S2>/S-Function Builder */
...
void servosfunc_initialize(void)
{
  ...
  /* External mode info */
  servosfunc_M->Sizes.checksums[0] = (3441248078U);
  servosfunc_M->Sizes.checksums[1] = (1256787093U);
  servosfunc_M->Sizes.checksums[2] = (3758679018U);
  servosfunc_M->Sizes.checksums[3] = (1916799832U);
  ...
  /* InitializeConditions for S-Function (bloque1): '<S2>/S-Function Builder' */
