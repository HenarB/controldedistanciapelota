...
typedef struct {
  ...
  real_T FilterDifferentiatorTF_states;/* '<S4>/Filter Differentiator TF' */
 ...
 * '<S3>'   : 'servosfunc/Discrete PID Controller/Clamping circuit'
 * '<S4>'   : 'servosfunc/Discrete PID Controller/Filter Differentiator'
 */
